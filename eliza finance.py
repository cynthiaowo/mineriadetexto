...
SCRIPT_DIR = os.path.join(PROJECT_DIR, 'scriptsfin')
GENERAL_SCRIPT_PATH = os.path.join(SCRIPT_DIR, 'generalfin.json')
SCRIPT_PATH = os.path.join(SCRIPT_DIR, 'finance.json')
